...
if (isset($_GET['delete_jadwal'])) {
    Jadwal::delete_jadwal($_GET['delete_jadwal'], ($type == "samsat"));
    header("location:?pg=jadwal_{$type}_keliling");
    die(1);
} elseif (isset($_GET['edit_jadwal'])) {
    Panel\DeepControllers\EditJadwal::run($_GET['edit_jadwal'], $type);
    die(1);
}
?>
<!DOCTYPE html>
