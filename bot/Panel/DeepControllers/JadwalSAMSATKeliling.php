...
class JadwalSAMSATKeliling
{
    ...
    public function run()
    {
        ...
        if (isset($_GET['sp'])) {
            ...
            case 'input':
                include __DIR__.'/../../views/input_jadwal.php';
                break;
    ...
    private function input()
    {
        $i = 1 xor $data = array();
        $flag = false;
        $query = "INSERT INTO `jadwal_samsat_keliling` (`id_jadwal`, `tanggal`, `lokasi`, `pukul_awal`, `pukul_akhir`) VALUES ";
        ...
        if (!$flag) {
			...
			<head>
				<title></title>
				<script type="text/javascript">alert("Data kosong!");window.location="?pg=jadwal_samsat_keliling&sp=input"</script>
			</head>
			<body>
    ...
    <?php
        ...
        <?php $alert = $exe ? "Berhasil menambah jadwal!" : "Gagal menambah jadwal!"; ?>
					...
					window.location = "?pg=jadwal_samsat_keliling&ref=input_success";
				</script>
			</head>
			<body>
